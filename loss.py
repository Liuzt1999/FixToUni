...
class RankingLoss(torch.nn.Module):
    def __init__(self, embedding_size=128, margin_latent = 0.5, margin_embedding = 0.5, margin_anchor = 0.5, N = 2, r = 1.0):
        ...
        self.margin_latent = margin_latent #latent space�еı߽�
        self.margin_embedding = margin_embedding #embedding�еı߽�
        self.margin_anchor = margin_anchor
        self.N = N #��������������
        self.r = r #����仯�ĵ�λǿ��
        self.embedding_size = embedding_size #latent space��������size
